        ...
        )
{
    ...
    // Create a Handle with the Hash2 Protocol
    Status = mHash2ServiceBindingProtocol->CreateChild (mHash2ServiceBindingProtocol, &Hash2Handle);
        
    // Retrieve the Hash2Protocol from Hash2Handle
